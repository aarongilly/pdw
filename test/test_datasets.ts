...
export const bookDef: dj.Def = {
    ...
    _lbl: "Book",
    _emoji: "📖",
    _description: "The name of the book you read.",
    _updated: "m0ofg4dw",
...
export const movieDef: dj.Def = {
    ...
    _lbl: "Movie",
    _emoji: "🎬",
    _description: "The name of the movie you watched.",
    _updated: "m0ofg4dw",
    _scope: dj.DefScope.MINUTE,
    _type: dj.DefType.TEXT,
    _tags: ['media'],
...
const newMovieDef: dj.Def = {
    ...
    _lbl: "First Watch?",
    _emoji: "🎞️",
    _description: "Is this the first time you've seen this movie?",
    _updated: "m0ofg4dw",
    _scope: dj.DefScope.MINUTE,
...
const sleepDef: dj.Def = {
    ...
    _lbl: "Sleep Duration",
    _emoji: "🛌",
    _description: "How long your ring says you slept.",
    _updated: "m0ofg4dw",
...
const runDef: dj.Def = {
    ...
    _lbl: "Run",
    _emoji: "🏃‍♂️‍➡️",
    _description: "How far you jogged.",
    _updated: "m0ofg4dw",
...
const updatedRunDef: dj.Def = {
    ...
    _lbl: "Run (mi)",
    _emoji: "🏃‍♂️‍➡️",
    _description: "How far you jogged, in miles",
...
const ateOutDef: dj.Def = {
    ...
    _lbl: "Ate Out",
    _emoji: "🍔",
    _description: "You ate out. This is the name of the place you ate out at.",
    _updated: "m0ofg4dw",
    _scope: dj.DefScope.MINUTE,
    _type: dj.DefType.TEXT,
    _tags: ['health', 'money'],
...
const workoutTypeDef: dj.Def = {
    ...
    _lbl: "Workout Type",
    _emoji: "🏋️",
    _description: "You did a broad workout of this type",
    _updated: "m0ofg4dw",
    _scope: dj.DefScope.HOUR,
...
const workoutNameDef: dj.Def = {
    ...
    _lbl: "Workout Name",
    _emoji: "💪",
    _description: "The name of the routine, or brief description of it.",
    _updated: "m0ofg4dw",
    _scope: dj.DefScope.HOUR,
    _type: dj.DefType.TEXT,
    _tags: ['health'],
